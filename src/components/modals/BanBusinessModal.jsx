...
export default function BanBusinessModal({
    open,
    onOpenChange,
                ...
                <div className="space-y-6 py-2">
                    ...
                    <div className="rounded bg-yellow-50 border border-yellow-200 px-3 py-2">
                        <p className="text-xs text-yellow-800">
                            <span className="font-medium">Note:</span> This action will automatically disable all business operations and notify the owner(s).
                        </p>
                    </div>
                </div>
